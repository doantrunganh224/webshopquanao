...
?>
    <div class="arrow-steps clearfix">
        <div class="step "> <span> <a href="../giohang/cart.php" >Giỏ hàng</a></span> </div>
  ...
  ?>
    ...
    ?>
        <tr>
            ...
            <td><img src="../../../admin/modules/quanlyao/uploads/<?php echo $cart_item['hinhanh'] ?>" width="150px"></td>
            ...
            <td><a href="pages/main/giohang/xoaao.php?xoa=<?php echo $cart_item['id'] ?>" class="btn btn-success">XÓA</a></td>
        </tr>
    ...
    ?>
  	...
  	<div class="col-md-4 hinhthucthanhtoan">
		...
		foreach($_SESSION['cart'] as $key => $value){
			$thanhtien = $value['soluong']*$value['giaao'];
  			$tongtien+=$thanhtien;
		} 

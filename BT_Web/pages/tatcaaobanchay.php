     ...
     <section class="category">
        <div class="container">
            <div class="category-top row">
                <p>Trang chủ</p> <i class="fa fa-long-arrow-right" aria-hidden="true"></i> <p>Tất cả sản phẩm bán chạy</p>
            </div>
        </div>
        <div class="container">
            <div class="row">
                ...
                <div class="category-right row">
                    ...
                    <div class="category-main__content row">
                        <?php include("main/sanphambanchay.php");?>
                    </div>
